...
import Deletebutton from "./deleteMyAdds"
...
//console.log(id)
   ...
   const response = await axios.get(`https://capstoneproject-server--harry-potter1.repl.co/myadds/${id}`, {
  headers: {
